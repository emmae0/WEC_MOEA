...
def general_WAMIT_control(geom_vector,make_mesh_figure,frequencies,NN,modes,betas,water_depth,dir_name,rho,xCG,zCG,I55,beta_PTO,k_PTO,ulen,IALTFRC):
  ...
  # IALTFRC - this is an integer specifying the alternative forms of the FRC file -- see WAMIT user manual
  ...
  from make_gdf_w_top import make_gdf
  ...
  ### get added mass and damping out from the text files and put them into lists
